...
export default function Landing() {
  ...
  const copy = pt ? {
    ...
    proof: "Uma superfície de dados. Menos serviços para operar.", runTitle: "Execute em poucos minutos.", runLead: "Inicie um nó AxonBase com dados persistentes, autenticação e acesso pela porta 8000.", runAction: "Depois, conecte pela documentação.",
    ...
    proof: "One data surface. Fewer services to operate.", runTitle: "Run it in minutes.", runLead: "Start an AxonBase node with persistent data, authentication, and access on port 8000.", runAction: "Then connect through the documentation.",
  ...
  return <main className="landing landing-reframed">
    ...
    <section className="landing-hero">
      ...
      <figure className="landing-engine"><img src="/images/landing/axonbase-data-core.png" alt="Núcleo abstrato de dados AxonBase" /><figcaption><span>AXONBASE ENGINE</span><b>01</b> SQL <b>02</b> VECTOR <b>03</b> TRANSACTIONS</figcaption></figure>
    </section>
    <section className="landing-proof"><span>{copy.proof}</span><div><b>01</b> engine <b>02</b> protocol <b>03</b> operations</div></section>
    <section className="landing-run"><div><p className="landing-index">QUICK START / DOCKER</p><h2>{copy.runTitle}</h2><p>{copy.runLead}</p><Link to="/getting-started">{copy.runAction} <b>→</b></Link></div><pre><code>{`docker run -d --name axonbase -p 8000:8000 \\
...
function FeatureGlyph({ group, index }: { group: "model" | "feature" | "case"; index: number }) {
  const paths = group === "model"
    ? ["M4 5h16v14H4zM8 9h8M8 13h5", "M5 6h5v5H5zM14 13h5v5h-5zM10 10l4 4", "M5 7h14v10H5zM8 10h.01M8 13h.01M12 10h4M12 13h4", "M5 14c3-8 11-8 14 0M7 14a5 5 0 0 1 10 0M12 4v5", "M6 6h12M6 10h12M6 14h8M6 18h5", "M12 4a8 8 0 1 0 8 8M12 8a4 4 0 0 0-4 4" ]
    : group === "feature"
      ? ["M4 12h6l2-5 3 10 2-5h3", "M5 7h14v10H5zM8 10l4 4 4-4", "M6 18V6h12v12M9 10h6M9 14h4", "M12 5v7l4 3M5 12a7 7 0 1 0 14 0", "M6 17l6-12 6 12M8 14h8", "M5 18V9l4-4 4 4 3-3 3 3M8 18v-4h2v4M14 18v-5h2v5", "M12 4l7 3v5c0 4-3 7-7 8-4-1-7-4-7-8V7l7-3Z", "M5 18V6M10 18V10M15 18V8M20 18V4" ]
      : ["M5 17V7h14v10M8 13h8", "M5 17h14M7 14l3-4 3 2 4-5", "M5 17V8l4 3 3-5 3 4 4-2" ];
  return <svg className={`feature-glyph ${group}`} viewBox="0 0 24 24" aria-hidden="true"><path d={paths[index % paths.length]} /></svg>;
}
